...
# writer
writer = SummaryWriter('/home/enliai/Desktop/tmp')
...
# Image Preprocessing
# data agumentation & data random croping
...
# data parallel in module level

# model = DistributedDataParallel(model)  # all GPU be default
